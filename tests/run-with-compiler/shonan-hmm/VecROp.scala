...
class VecRDyn[T: Type](implicit st: StagingContext) extends VecDyn with VecROp[Expr[Int], Expr[T], Expr[Unit]] {
...
class VecRStaDim[T: Type](r: Ring[T])(implicit st: StagingContext) extends VecROp[Int, T, Expr[Unit]]  {
...
class VecRStaDyn[T : Type : Liftable](r: Ring[PV[T]])(implicit st: StagingContext) extends VecROp[PV[Int], PV[T], Expr[Unit]] {
...
class VecRStaOptDynInt(r: Ring[PV[Int]])(implicit st: StagingContext) extends VecRStaDyn(r) {
