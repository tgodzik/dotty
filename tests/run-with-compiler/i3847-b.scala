...
object Arrays {
  implicit def ArrayIsLiftable[T: Liftable](implicit t: Type[T], ctx: QuoteContext): Liftable[Array[List[T]]] = {
    new Liftable[Array[List[T]]] {
      def toExpr(arr: Array[List[T]])(implicit qCtx: QuoteContext): Expr[Array[List[T]]] = '{
