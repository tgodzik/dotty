...
//  case class Linear2[A](producer: Producer2[A]) extends StagedStream[A]
//  case class Nested[A, B](producer: Producer[B], nestedf: B => StagedStream[A]) extends StagedStream[A]
//
//  case class Stream2[A](stream: StagedStream[A]) {
//
//  }
//
//  inline def fold[A, W](st: Stream2[A], z: W, f: (W, A) => W): W
//
//
...
//  }
//
//  class Var2[T](var x: T)
//  object Stream {
//    def of[A: Type](arr: Array[A]): Stream2[A] = {
//      val prod = new Producer2[A] {
//        type St = (Var2[Int], Var2[Int], Array[A])
//
//        val card = Many
//
//        def init(k: St => Unit): Unit = {
//          val n = new Var2(arr.length)
//          val i = new Var2(0)
//          k((i, n, arr))
//        }
//
...
//      }
//
//      Stream2(Linear2(prod))
//    }
//
//    def ofImpl[A: Type](arr: Expr[Array[A]]): Stream[A] = {
