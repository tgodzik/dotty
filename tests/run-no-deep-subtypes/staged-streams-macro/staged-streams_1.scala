...
// sbt:dotty> ;dotc tests/run-no-deep-subtypes/staged-streams-macro/staged-streams_1.scala; dotc -classpath . tests/run-no-deep-subtypes/staged-streams-macro/Test_2.scala -Xprint:front,reify,genB -optimise
  inline def test1(arr: Array[Int]) = ~{
    Stream
     .of('{arr})
