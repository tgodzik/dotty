...
//
//class TastyPrinter(implicit ctx: Context) {
//  import ctx.impl._
//
//  def stringOf(tree: Tree): String = {
//    implicit val buff: StringBuilder = new StringBuilder
//    visit(tree)
//    buff.toString()
//  }
//
//  def stringOf(tpe: MaybeType): String = {
//    implicit val buff: StringBuilder = new StringBuilder
//    visit(tpe)
//    buff.toString()
//  }
//
//  def stringOf(name: Name): String = {
//    implicit val buff: StringBuilder = new StringBuilder
//    visit(name)
//    buff.toString()
//  }
//
//  def stringOf(name: PossiblySignedName): String = {
//    implicit val buff: StringBuilder = new StringBuilder
//    visit(name)
//    buff.toString()
//  }
//
//  def stringOf(mod: Modifier): String = {
//    implicit val buff: StringBuilder = new StringBuilder
//    visit(mod)
//    buff.toString()
//  }
//
//  def stringOf(mod: Constant): String = {
//    implicit val buff: StringBuilder = new StringBuilder
//    visit(mod)
//    buff.toString()
//  }
//
//  private def visit(tree: Tree)(implicit buff: StringBuilder): Unit = tree match {
//    case Ident(name) =>
//      buff append "Ident("
//      visit(name: Name)
//      buff append ")"
...
//  }
//
//  private def visitAny(x: Any)(implicit buff: StringBuilder): Unit = x match {
//    case x: Tree => visit(x)
...
//  }
//
//  private def visit(const: Constant)(implicit buff: StringBuilder): Unit = {
//    import ctx.impl._
//    const match {
...
//  }
//
//  private def visit(name: PossiblySignedName)(implicit buff: StringBuilder): Unit = name match {
...
//  }
//
//  private def visit(name: Name)(implicit buff: StringBuilder): Unit = name match {
...
//  }
//
//  private def visit(selector: ImportSelector)(implicit buff: StringBuilder): Unit = selector match {
...
//  }
//
//  private def visit(tpe: MaybeType)(implicit buff: StringBuilder): Unit = {
...
//  }
//
//  private def visit(mod: Modifier)(implicit buff: StringBuilder): Unit = mod match {
//    case Flags(flags) =>
