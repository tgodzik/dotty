...
trait Unpickler {
  // TODO hide methods
  /*private[Unpickler]*/ def unpickleExpr[T](repr: Unpickler.Pickled, args: Seq[Any]): Expr[T]
  /*private[Unpickler]*/ def unpickleType[T](repr: Unpickler.Pickled, args: Seq[Any]): Type[T]
}
